...
记录使用 github workflow 实现自动部署 Github Pages 的过程。本文为**实况向**，记录研究全程，包含大量试错及踩坑过程。**教程向**看这篇[《TODO 名字》](post:a68feaba-5746-4def-b77e-95d89933cf1c)
...
[Working with lockfiles](https://github.com/actions/setup-node/blob/main/docs/advanced-usage.md#caching-packages-dependencies)
